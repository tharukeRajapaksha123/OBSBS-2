   ...
   <div class="body">
      ...
      <div class="glass-card">
         <form action="edit_service_service.php" method="post">
            ...
            Image Link : <input name="image" value=<?php echo ($service_image) ?>
               placeholder="Paste your service image link here"><br>
            Price : <input name="price" value=<?php echo ($service_price) ?>><br>
            <input id="btn" type="submit" value="Update Service">
         </form>
